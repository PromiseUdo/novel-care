...
//           <div className="flex flex-col-reverse md:flex-row items-center justify-between min-h-[400px] pb-[40px] gap-[108px] ">
...
//                 className="absolute top-[40px] left-[-50px] w-[200px] h-[217px] md:w-[300px] md:h-[325px]"
//               />
//               <img
//                 src="/about2.png"
//                 alt="Top background image"
//                 className="absolute top-0 right-0 w-[200px] h-[217px] md:w-[300px] md:h-[325px]"
//               />
//             </div>
//           </div>

//           {/* Added min-h-[400px] to ensure flex container has enough height for items-center */}
//           <div className="flex flex-col-reverse md:flex-row items-center justify-between min-h-[400px] gap-[108px] ">
//             <div className="relative w-full h-full self-stretch">
//               <img
//                 src="/about3.png"
//                 alt="Bottom background image"
//                 className="absolute top-[40px] left-0 w-[200px] h-[217px] md:w-[300px] md:h-[325px]"
//               />
//               <img
//                 src="/about2.png"
//                 alt="Top background image"
//                 className="absolute top-0 right-[-40px] w-[200px] h-[217px] md:w-[300px] md:h-[325px] scale-x-[-1]"
//               />
//             </div>
...
//           <div className="flex flex-col-reverse md:flex-row items-center gap-[78px]  xl:mt-[-85px]">
//             {/* Fixed width for image div to preserve full shape */}
//             <div className="relative flex-none w-[200px] h-[217px] md:w-[300px] md:h-[325px]">
//               <img
//                 src="/about4.png"
//                 alt="Bottom background image"
//                 className="absolute top-[0px] left-[28px] w-[200px] h-[217px] md:w-[300px] md:h-[325px]"
//               />
//             </div>
