...
import { FeedbackSchemaType } from "@/types/feedback-schema";

interface FeedbackFormEmailProps {
  formData: FeedbackSchemaType;
}

export const FeedbackFormEmailTemplate: React.FC<FeedbackFormEmailProps> = ({
  formData,
}) => {
  const {
    firstName,
  ...
  // Map feedback categories to human-readable labels
  const categoryLabels: { [key: string]: string } = {
    CommunicationIssue: "Communication Issue",
    PolicyProcedureIssue: "Policy/Procedure Issue",
    PrivacyConfidentiality: "Privacy/Confidentiality",
  ...
  return (
    ...
    >
      ...
      >
        New feedback/complaint submission from {firstName} {lastName}
      </div>
      ...
      >
        ...
        <div style={{ padding: "24px" }}>
          ...
          >
            New Feedback/Complaint Submission
          </h1>
          <p
            style={{ fontSize: "16px", color: "#4E4D4D", marginBottom: "24px" }}
          >
            A new feedback or complaint has been submitted by {firstName}{" "}
            {lastName}. Below are the details:
          </p>
          ...
          <table style={{ width: "100%", fontSize: "14px", color: "#333333" }}>
            ...
            <tr>
              <td style={{ padding: "8px 0", fontWeight: 500 }}>Details</td>
              <td>{details}</td>
            </tr>
            <tr>
              <td style={{ padding: "8px 0", fontWeight: 500 }}>
              ...
              <td>{suggestedOutcome}</td>
            </tr>
            <tr>
              <td style={{ padding: "8px 0", fontWeight: 500 }}>
                Authorization
              </td>
              <td>{authorization ? "Yes" : "No"}</td>
            </tr>
          </table>
        </div>
        ...
        >
          ...
          <p style={{ margin: "0" }}>
            This email was sent because a feedback or complaint was submitted to
            Novel Care Services.
          </p>
        </div>
      </div>
